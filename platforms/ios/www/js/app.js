...
$(document)
  ...
  .on('pagecreate', '#membership', function() {
    function register($data, $popup, $popupTitle, $popupContent) {
      $.ajax({
        url: 'http://dev.foodshortage/api.php/register',
        type: "POST",
    ...
    function login($data, $popup, $popupTitle, $popupContent) {
      $.ajax({
        url: 'http://dev.foodshortage/api.php/login',
        type: "POST",
        contentType: "application/json",
        dataType: 'json',
        data: $data,
      ...
      .on('click', function() {
        ...
        $.fblogin({
          ...
          success: function(data) {
            ...
            console.log(data.first_name, data.email);
          }
        });
      })
      // openFB.init({
  ...
  .on('pagecreate', '#setting', function() {
    ...
    function update($data, $popup, $popupTitle, $popupContent) {
      $.ajax({
        url: 'http://dev.foodshortage/api.php/update',
        type: "POST",
        contentType: "application/json",
        dataType: 'json',
        data: $data,
    ...
    function rpassword($data, $popup, $popupTitle, $popupContent) {
      $.ajax({
        url: 'http://dev.foodshortage/api.php/rpassword',
        type: "POST",
        contentType: "application/json",
        dataType: 'json',
        data: $data,
